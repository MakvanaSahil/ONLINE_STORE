...
const Footer = () => {
    return (
        <>
            <footer className="bg-dark py-5 footerr">
                <div className="m-5 ">
                    <div className="row text-white g-4">
                        <div className="col-md-6 col-lg-4">
                            ...
                            <p className="text-white text-muted mt-3">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum mollitia quisquam
                                veniam odit cupiditate, ullam aut voluptas velit dolor ipsam? Lorem ipsum dolor sit
                                amet consectetur adipisicing elit. Nostrum mollitia quisquam veniam odit
                                cupiditate, ullam aut voluptas velit dolor ipsam?
                            </p>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-4">
                            ...
                            <div className="d-flex justify-content-start align-items-start my-2 text-muted">
                                ...
                                <span className="fw-light"> New york, USA </span>
                            </div>
                            <div className="d-flex justify-content-start align-items-start my-2 text-muted">
                                <span className="me-3">
